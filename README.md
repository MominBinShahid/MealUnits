...
- **772 tests**, including 77 golden cases that each carry the hand derivation of their expected
  value in the fixture.
- **100% mutation score** on the core, the state machine and `config.ts` — 1,818 mutants killed, 0
