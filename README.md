...
- **717 tests**, including 77 golden cases that each carry the hand derivation of their expected
  value in the fixture.
- **100% mutation score** on the core, the state machine and `config.ts` — 1,721 mutants killed, 0
...
Figures as of 2026-09-17. `npm run check` and `npm run mutate` print the current ones, and
