  ...
  },
  {
    ...
    text: {
      ...
      ur: {
        name: 'فروٹ چاٹ',
        portion: '1 کپ',
        varies: 'کون سے پھل ہیں، اور اوپر چینی کتنی چھڑکی۔ کیلا اور آم اوپر لے جاتے ہیں؛ سیب اور امرود نیچے رکھتے ہیں۔',
      },
    },
    roman: 'Fruit chaat',
  ...
  },
  {
    ...
    text: {
      ...
      ur: {
        ...
        varies: 'نمی۔ گڑ تقریباً پوری چینی ہی ہے — ہر 100\u00A0گرام میں 95 سے 98\u00A0گرام — اس لیے سارا جواب وزن ہے۔',
      },
    },
    roman: 'Gur',
