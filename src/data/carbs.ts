...
export interface Food {
   ...
   * SCRIPT, not the language: `script` below holds the same words in Urdu
   * letters, and two fields where one is called `urdu` is how the wrong one
   * gets filled in.
   *
   * This is the field SEARCH leans on for a QWERTY keyboard. Momin types
   * "roti" and "dal" whichever language the interface is in, so it stays
   * regardless of what `script` does.
   */
  readonly roman: string;
  /**
   * The same food in Urdu script — DISPLAY ONLY, never searched.
   *
   * Never searched is a decision rather than an omission. Matching Urdu script
   * would need the aliases mirrored into it and eight normalisation rules in
   * `fold()`, and without those it actively misleads: a review ran the real
   * ranking over the real table and found «دال» putting a 78 g rice dish above
   * every actual bowl of daal at 13 to 32 g. Momin does not search in Urdu, so
   * the whole hazard is avoided by not building it.
   *
   * EVERY VALUE IS DISTINCT FROM EVERY OTHER, and that is the property that
   * matters. 54 groups of rows share a `roman` and no two rows in any group
   * share a gram figure — four say 'Naan' and span 60 to 90 g — so two rows
   * reading alike would be a reader choosing blind on a number that becomes
   * insulin. The qualifier goes INTO the name here rather than being left to
   * the portion line: «تندوری نان، چھوٹا», not «نان».
   *
   * Brand words stay Latin inside the Urdu, per `docs/URDU.md` ruling 2 — a
   * token whose job is to match something the reader is holding stays in that
   * thing's script. Digits stay ASCII, per ruling 1.
   *
   * DRAFTED, NOT REVIEWED. Momin's mother is the native speaker and reads
   * every one of these. Nothing renders it yet.
   */
...
export const FOODS: readonly Food[] = [
  ...
  },
  {
    ...
    roman: 'Roti',
    script: 'گھر کی روٹی، بڑی اور پتلی',
  ...
  },
  {
    ...
    roman: 'Naan',
    script: 'ریسٹورنٹ کا نان، بٹر یا گارلک',
...
// ── Breads, naan family (CARBS.md 3.1) ────────────────────────────────────
  ...
  },
  {
    ...
    roman: 'Puri',
    script: 'پوری، حلوہ پوری دکان والی',
  ...
  // ── Rice dishes, and the rice-based sweets (CARBS.md 4) ───────────────────
  {
    ...
    roman: 'Pulao',
    script: 'پلاؤ، گوشت والا، بھری پلیٹ',
  ...
  },
  {
    ...
    roman: 'Biryani',
    script: 'بریانی، درمیانی دیگ، پلیٹ',
  ...
  },
  {
    ...
    roman: 'Biryani',
    script: 'بریانی، چاول زیادہ یا دیگ والی، پلیٹ',
  ...
  },
  {
    ...
    roman: 'Biryani',
    script: 'بریانی، گوشت زیادہ، دعوت کی پلیٹ',
  ...
  },
  {
    ...
    roman: 'Biryani',
    script: 'بریانی، درمیانی دیگ، دعوت کی پلیٹ',
    aliases: ['biryani', 'biriyani', 'briyani', 'biriani', 'shaadi biryani', 'dawat biryani'],
    portion: '1 dawat plate, 400\u00A0g',
    grams: 68,
    gramsMax: null,
  ...
  },
  {
    ...
    roman: 'Biryani',
    script: 'بریانی، چاول زیادہ یا دیگ والی، دعوت کی پلیٹ',
  ...
  },
  {
    ...
    roman: 'Biryani',
    script: 'بریانی، پلیٹ، دیگ معلوم نہیں',
  ...
  },
  {
    ...
    roman: 'Karela',
    script: 'کریلا، سادہ یا قیمہ والا',
  ...
  },
  {
    ...
    roman: 'Seekh kabab',
    script: 'سیخ کباب، تکہ، مچھلی یا انڈا',
  ...
  },
  {
    ...
    roman: 'Fried fish',
    script: 'تلی ہوئی مچھلی، مسالے والی',
  ...
  // ── Snacks and street food (CARBS.md 7) ────────────────────────────────────
  {
    ...
    roman: 'Aloo samosa',
    script: 'آلو سموسہ، کاک ٹیل چھوٹا',
  ...
  },
  {
    ...
    roman: 'French fries',
    script: 'فرنچ فرائز، ٹھیلے کا کون',
  ...
  },
  {
    ...
    roman: 'French fries',
    script: 'فرنچ فرائز، فرنچائز میڈیم',
  ...
  },
  {
    ...
    roman: 'Spring roll',
    script: 'اسپرنگ رول یا چکن رول پٹی',
  ...
  },
  {
    ...
    roman: 'Gulab jamun',
    script: 'گلاب جامن، بڑا شیرے بھرا',
    aliases: ['gulab jamun', 'gulaab jamun', 'gulab jaman', 'jamun', 'mithai'],
  ...
  },
  {
    ...
    roman: 'Sewaiyan',
    script: 'سویاں، ابلی ہوئی بغیر دودھ',
  ...
  },
  {
    ...
    roman: 'Sindhi sayun',
    script: 'سندھی سیوں، گھی شکر والی',
  ...
  },
  {
    ...
    script: 'سوجی کا حلوہ، ناشتے والا',
  ...
  },
  {
    ...
    roman: 'Gajar ka halwa',
    script: 'گاجر کا حلوہ، 2 بھرے چمچ',
    aliases: ['gajar ka halwa', 'gajar halwa', 'gaajar ka halwa', 'carrot halwa', 'halwa', 'mithai'],
  ...
  },
  {
    ...
    roman: 'Sohan halwa',
    script: 'سوہن حلوہ، 25\u00A0گرام چھوٹا ٹکڑا',
  ...
  },
  {
    ...
    roman: 'Cheeni',
    script: 'چینی، بھرا ہوا چائے کا چمچ',
  ...
  },
  {
    ...
    roman: 'Doodh patti',
    script: 'دودھ پتی، پیالی، بغیر چینی',
  ...
  },
  {
    ...
    roman: 'Doodh patti',
    script: 'دودھ پتی، پیالی، 1 چمچ چینی',
    aliases: ['doodh patti', 'dodh patti', 'dudh patti', 'doodh pati', 'patti', 'chai', 'tea'],
    portion: '1 Pakistani cup, 150\u00A0ml',
    grams: 12,
    gramsMax: null,
  ...
  },
  {
    ...
    roman: 'Doodh patti',
    script: 'دودھ پتی، پیالی، 2 چمچ چینی',
    aliases: ['doodh patti', 'dodh patti', 'dudh patti', 'doodh pati', 'patti', 'chai', 'tea'],
    portion: '1 Pakistani cup, 150\u00A0ml',
    grams: 16,
    gramsMax: null,
  ...
  },
  {
    ...
    roman: 'Doodh patti',
    script: 'دودھ پتی، پیالی، 3 چمچ چینی',
    aliases: ['doodh patti', 'dodh patti', 'dudh patti', 'doodh pati', 'patti', 'chai', 'tea'],
    portion: '1 Pakistani cup, 150\u00A0ml',
    grams: 20,
    gramsMax: null,
  ...
  },
  {
    ...
    roman: 'Doodh patti',
    script: 'دودھ پتی، بڑا مگ، بغیر چینی',
    aliases: ['doodh patti', 'dodh patti', 'dudh patti', 'doodh pati', 'patti', 'chai', 'tea'],
    portion: '1 large mug, 250\u00A0ml',
    grams: 13,
    gramsMax: null,
  ...
  },
  {
    ...
    roman: 'Doodh patti',
    script: 'دودھ پتی، بڑا مگ، 1 چمچ چینی',
    aliases: ['doodh patti', 'dodh patti', 'dudh patti', 'doodh pati', 'patti', 'chai', 'tea'],
    portion: '1 large mug, 250\u00A0ml',
    grams: 17,
    gramsMax: null,
  ...
  },
  {
    ...
    roman: 'Doodh patti',
    script: 'دودھ پتی، بڑا مگ، 2 چمچ چینی',
    aliases: ['doodh patti', 'dodh patti', 'dudh patti', 'doodh pati', 'patti', 'chai', 'tea'],
    portion: '1 large mug, 250\u00A0ml',
    grams: 21,
    gramsMax: null,
  ...
  },
  {
    ...
    roman: 'Doodh patti',
    script: 'دودھ پتی، بڑا مگ، 3 چمچ چینی',
    aliases: ['doodh patti', 'dodh patti', 'dudh patti', 'doodh pati', 'patti', 'chai', 'tea'],
    portion: '1 large mug, 250\u00A0ml',
    grams: 26,
    gramsMax: null,
  ...
  },
  {
    ...
    roman: 'Chai',
    script: 'چائے میں کنڈینسڈ ملک، فی چمچ',
  ...
  // ── Other drinks (CARBS.md 9.2) ────────────────────────────────────────────
  {
    ...
    roman: 'Qahwa',
    script: 'قہوہ یا سبز چائے، بغیر چینی',
  ...
  },
  {
    ...
    roman: 'Soft drink',
    script: 'کولڈ ڈرنک، بڑی بوتل (آدھا لیٹر)',
  ...
  // ── Ramadan quick sheet (CARBS.md 12) ──────────────────────────────────────
  {
    ...
    roman: 'Khajoor',
    script: 'افطار کی 3 چھوٹی کھجوریں',
  ...
  },
  {
    ...
    roman: 'Aloo',
    script: 'آلو کا ٹکڑا، سالن یا بریانی کا',
  ...
  },
  {
    ...
    roman: 'Besan',
    script: 'بیسن کی تہہ (کوٹنگ)، فی پلیٹ',
  ...
  // ── Meals as served, pre-added (CARBS.md 14) ───────────────────────────────
  {
    ...
    roman: 'Biryani',
    script: 'بریانی پلیٹ، درمیانی دیگ، رائتے کے ساتھ',
  ...
  },
  {
    ...
    roman: 'Biryani',
    script: 'بریانی پلیٹ، دیگ یا کمرشل، رائتے کے ساتھ',
  ...
  },
  {
    ...
    roman: 'Biryani',
    script: 'بریانی پلیٹ، گوشت زیادہ، رائتے کے ساتھ',
  ...
  },
  {
    ...
    roman: 'Nihari',
    script: 'نہاری، 2 تندوری نان کے ساتھ',
  ...
  },
  {
    ...
    roman: 'Nihari',
    script: 'نہاری، 1 تندوری نان کے ساتھ',
    aliases: ['nihari', 'nehari', 'nihari naan', 'nihari meal', 'naan', 'curry', 'salan'],
  ...
  },
  {
    ...
    roman: 'Halwa puri',
    script: 'حلوہ پوری ناشتہ، 2 پوریاں',
    aliases: ['halwa puri', 'halwa poori', 'nashta', 'breakfast', 'puri halwa'],
  ...
  },
  {
    ...
    roman: 'Sehri',
    script: 'سحری: پراٹھا، آملیٹ اور دودھ پتی',
  ...
  },
  {
    ...
    roman: 'Qorma',
    script: 'قورمہ، 1 نان کے ساتھ (دعوت)',
  ...
  },
  {
    ...
    roman: 'Bun kabab',
    script: 'بن کباب، کولڈ ڈرنک کے ساتھ',
  ...
  },
  {
    ...
    roman: 'Kabab paratha roll',
    script: 'کباب پراٹھا رول، کولڈ ڈرنک کے ساتھ',
  ...
  },
  {
    ...
    roman: 'Shaadi plate',
    script: 'شادی کی پلیٹ: قورمہ، نان، زردہ، کولڈ ڈرنک',
  ...
  },
  {
    ...
    roman: 'Chana chaat',
    script: 'چنا چاٹ، ٹھیلے والی، آلو اور میٹھی چٹنی',
  ...
  // generic reference, and a formulation changes by country and by year.
  {
    ...
    script: 'Cadbury Dairy Milk چاکلیٹ، سنگل بار',
  ...
  },
  {
    ...
    roman: 'Cadbury Dairy Milk',
    script: 'Cadbury Dairy Milk چاکلیٹ، بڑا بلاک',
  ...
  },
  {
    ...
    script: 'Lindt Excellence ڈارک چاکلیٹ، 70 فیصد',
  ...
  },
  {
    ...
    roman: 'Lindt Excellence',
    script: 'Lindt Excellence ڈارک چاکلیٹ، 85 فیصد',
  ...
  },
  {
    ...
    roman: 'Lindt Excellence',
    script: 'Lindt Excellence ڈارک چاکلیٹ، 90 فیصد',
  ...
  },
  {
    ...
    script: 'Cadbury Dairy Milk Caramel چاکلیٹ، سنگل بار',
  ...
  },
  {
    ...
    roman: 'Cadbury Dairy Milk Caramel',
    script: 'Cadbury Dairy Milk Caramel چاکلیٹ، بڑا بلاک',
  ...
  },
  {
    ...
    roman: 'KitKat',
    script: 'KitKat ویفر چاکلیٹ، 4 فنگر',
  ...
  },
  {
    ...
    script: 'کریم والے بسکٹ، چھوٹا پیک',
  ...
  },
  {
    ...
    roman: 'Loacker Classic Napolitaner',
    script: 'کریم ویفر، برانڈ معلوم نہیں',
  ...
  },
  {
    ...
    roman: 'Boiled sweets',
    script: 'سخت ٹافی (چوسنے والی)، 1 عدد',
  ...
  },
  {
    ...
    roman: 'Boiled sweets',
    script: 'سخت ٹافی (چوسنے والی)، پورا ڈبہ',
  ...
  },
  {
    ...
    roman: 'Toffees',
    script: 'نرم ٹافی (کیریمل)، پوری تھیلی',
  ...
  },
  {
    ...
    script: 'کارن اسنیکس یا چیز پفس، چھوٹا پیک',
  ...
  },
  {
    ...
    roman: 'Extruded corn snacks',
    script: 'کارن اسنیکس یا چیز پفس، درمیانہ پیک',
    aliases: ['corn snacks', 'cheese puffs', 'cheetos', 'kurkure', 'crisps', 'chips', 'extruded corn snacks'],
  ...
  },
  {
    ...
    roman: 'Extruded corn snacks',
    script: 'کارن اسنیکس یا چیز پفس، بڑا پیک',
  ...
  },
  {
    ...
    script: 'نمکین مونگ پھلی، چھوٹا پیک',
  ...
  },
  {
    ...
    roman: 'Salted peanuts',
    script: 'نمکین مونگ پھلی، بڑا پیک',
  ...
  // ── Habshi halwa, the two labelled products (CARBS.md 20.2) ────────────────
  {
    ...
    script: 'Royal Special حبشی حلوہ',
