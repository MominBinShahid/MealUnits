...
export const COPY_UR: Copy = {
  ...
  glossary: {
    ...
    carbohydrate: {
      word: 'کاربوہائیڈریٹ',
      body: 'کھانے کا وہ حصہ جو بلڈ شوگر بن جاتا ہے: روٹی کا آٹا، چاول، چائے کی چینی۔ گوشت، انڈا اور تیل کاربوہائیڈریٹ نہیں ہیں اور بلڈ شوگر کو بہت کم ہلاتے ہیں۔ یہ پلیٹ کا وزن نہیں ہے — 300\u00A0گرام بریانی میں تقریباً 50\u00A0گرام کاربوہائیڈریٹ ہوتا ہے۔',
    },
    diabetes: {
      word: 'ذیابیطس',
  ...
  foods: {
    ...
    sugarFreeTitle: 'شوگر فری دو الگ الگ چیزیں ہیں',
    sugarFreeDrinks:
      'مشروبات — ڈائٹ یا زیرو کولا، بغیر چینی شربت، پھیکی چائے یا کافی: ان میں چینی کی جگہ ایسپارٹیم یا سکرالوز ہوتا ہے، شوگر الکحل نہیں۔ ان میں گننے کے قابل کچھ نہیں۔ اس کی لائن دیکھنے کے لیے «diet drink» تلاش کریں۔',
    sugarFreeSweets:
      'مٹھائی اور چیونگم — ان میں شوگر الکحل ہوتی ہے: maltitol، sorbitol، xylitol۔ ڈبے پر یہ کاربوہائیڈریٹ میں گنی جاتی ہے، مگر جسم اس کا بہت کم جذب کرتا ہے۔ اس لیے ڈبے والے عدد پر انسولین لگانے کا مطلب ہے ایسے کھانے کی انسولین جو دراصل ہے ہی نہیں۔ کوئی ایماندار حساب نہیں بنتا، اس لیے اس فہرست میں ان کا کوئی عدد نہیں۔ کھانا ہو تو کھائیں؛ ان کے لیے انسولین لگانے کے بجائے اپنی شوگر دیکھتے رہیں، اور انہیں کھانے کی طرح شمار کرنے سے پہلے اپنے ڈاکٹر سے پوچھیں۔',
    /**
    ...
    matrixWhat: 'ہر خانے میں ایک بار کے کھانے کا کاربوہائیڈریٹ ہے۔',
    matrixRule: {
  ...
  clear: {
    ...
    startOverBody:
      'سب کچھ ختم ہو جائے گا: ریکارڈ، آپ کا نسخہ، اس کی ہسٹری، آپ کے اپنے تولے ہوئے اعداد، اور وہ نوٹ کہ آپ پہلے ڈوز کیسے طے کرتے تھے۔ سیٹ اپ دوبارہ چلے گا۔ اسے واپس نہیں کیا جا سکتا۔',
  ...
  calculator: {
    ...
    carbsHint:
      'کھانے کے اندر کا کاربوہائیڈریٹ — یہ نہیں کہ پلیٹ کا وزن کتنا ہے۔ بریانی کی 300\u00A0گرام کی پلیٹ میں تقریباً 50\u00A0گرام کاربوہائیڈریٹ ہوتا ہے۔',
