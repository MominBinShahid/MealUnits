...
export const COPY_UR: Copy = {
  ...
  glossary: {
    ketones: {
      word: 'کیٹون',
      body: 'جب جسم میں انسولین کم پڑ جائے تو وہ شوگر کی جگہ چربی جلانے لگتا ہے، اور اس سے کیٹون بنتے ہیں۔ زیادہ ہو جائیں تو خون تیزابی ہو جاتا ہے — یہ خطرناک ہے اور گھنٹوں میں بگڑتا ہے۔ لیب کی رپورٹ پر یہ لفظ انگریزی میں "Ketones" لکھا ہوتا ہے۔ چوبیس گھنٹے کھلی لیب چند سو روپے میں پیشاب کا ٹیسٹ کر دیتی ہے؛ عام میڈیکل سٹور پر یہ پٹیاں نہیں ملتیں۔',
    },
    ketoacidosis: {
      word: 'کیٹو ایسڈوسس',
